...
startingState = [] # the initial board state upon beginning a game; don't modify!
currentState = [] # the current "applied" board state
firstMove = True # ratchet boolean to store startingState
