"""copy of Ratchet lined with try-catch blocks to minimize risk of failure during main tournament"""
...
def chooseMove(board,gameState):
    ...
    #choose a move prioritizing 1) escapeTrail, 2) approachOpponent, 3) tryPurchaseUpgrade. use try-except blocks to minimize risk of error
    try:
        move = escapeTrail()
    except:
